      ...
      <el-main class="el-main" >
        <div class="list">
          <el-table
              ...
              stripe height="400px"
              style="width: 100%">
            <el-table-column label="学号" width="100px" prop="id">
            </el-table-column>
            <el-table-column
                prop="name"
                label="名字"
...
<!--              </template>-->
          ...
          <div class="pag">
            <el-pagination
                ...
                style="position: relative;left:410px;bottom: 20px"
            />
          </div>
          <div class="timer">
            <span>当前时间为：</span>
...
export default {
  ...
  created(){
    ...
    this.axios.get('http://localhost:3000/abList')
        .then((res)=>{
    ...
    this.axios.get('http://localhost:3000/pageInfo2')
        .then((res)=>{
...
// var day = now.getDay();//得到周几
    ...
    deleteIndex(id) {
      console.log(id)
      this.axios.delete('http://localhost:3000/profile/' + id,
          // {data:this.blog}
      )
          .then((res) => {
            this.$message.success('删除成功！')
